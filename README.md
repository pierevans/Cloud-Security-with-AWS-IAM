...
![AWS console EC2 instance detail showing the environment tag set to development on cloudlab-dev-web](screenshots/instance-with-tags.png)
...
![AWS IAM policy editor screenshot showing a custom policy restricting EC2 actions to resources tagged environment=development](screenshots/policy.png)
...
![AWS console screenshot showing IAM user pierre.konan assigned to the Developers group](screenshots/user.png)
...
![AWS console confirmation screenshot showing successful stop action on development instance cloudlab-dev-web](screenshots/successful-permission.png)
...
![AWS console error screenshot showing access denied when attempting to stop production instance cloudlab-prod-web](screenshots/failed-permission.png)
